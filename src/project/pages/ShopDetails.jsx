          ...
          <div className="row g-4">
            <div className="col-lg-6">
              <div className="border rounded">
                <a href="/">
                  <img src="img/single-item.jpg" className="img-fluid rounded" alt="new" />
                </a>
              </div>
            </div>
            <div className="col-lg-6">
              <h4 className="fw-bold mb-3">{data.Prod_name}</h4>
            ...
            <div className="col-lg-12">
              ...
              <div className="d-flex align-items-center justify-content-start">
                <div className="rounded" style={{width: 100, height: 100}}>
                  <img src="img/featur-1.jpg" className="img-fluid rounded" alt="Imge" />
                </div>
                <div>
