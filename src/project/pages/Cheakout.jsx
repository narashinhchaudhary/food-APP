                  ...
                  <tr>
                    <th scope="row">
                      <div className="d-flex align-items-center mt-2">
                        <img src={val.img} className="img-fluid rounded-circle" style={{width: 90, height: 90}} alt="" />
                      </div>
                    </th>
                    <td className="py-5">{val. prod_name}</td>
                    <td className="py-5">{val.price}</td>
                    <td className="py-5">{cart[index].quantity}</td>
                    <td className="py-5">{val.price}</td>
                  </tr>
